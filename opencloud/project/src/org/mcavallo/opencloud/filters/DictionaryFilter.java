...
public class DictionaryFilter extends TagFilter {
	...
	/** Flag to make the filter case sensitive or case insensitive */
	...
	/**
	 * @param ignoreCase Whether or not we should perform case insensitive
	 * comparisons
	 */
    ...
    /**
     * @return Returns whether or not we are case insensitive
     */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DictionaryFilter other = (DictionaryFilter) obj;
		if (blackList == null) {
